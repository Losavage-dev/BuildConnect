...
--   3) опционально verify_all_companies_demo.sql — если в БД уже есть другие компании
--      и нужно показать их все в каталоге как верифицированные (перезапишет любые статусы модерации).
--
