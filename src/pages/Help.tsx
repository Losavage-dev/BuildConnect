...
const Help = () => (
  ...
  >
    ...
    <section className="space-y-3">
      ...
      <p className="text-sm text-muted-foreground">
        <strong className="text-foreground">Шаблоны договоров</strong> (только после входа): в профиле — пункт «Шаблоны
        договоров»; документ можно скачать в форматах .docx и .pdf. Подписанный файл передайте контрагенту через кнопку со
        скрепкой в чате заявки (до 20 МБ).
      </p>
    </section>
